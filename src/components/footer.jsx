    ...
    <footer className="bg-black text-white py-8 sm:py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          {/* Navigation Links */}
          <div className="col-span-1 sm:col-span-2 md:col-span-3 mt-8 sm:mt-0">
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-4 md:gap-8">
              {/* Platform Links */}
              <div>
        ...
        <div className="mt-10 sm:mt-12 md:mt-16 pt-6 sm:pt-8 border-t border-gray-800">
          <div className="flex flex-col sm:flex-row justify-between gap-4 text-xs sm:text-sm text-gray-400">
            <p className="text-center sm:text-left">
              © 2023 Crypt Land. All rights reserved
            </p>
